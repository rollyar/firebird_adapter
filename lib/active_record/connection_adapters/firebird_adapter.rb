...
class FirebirdAdapter < AbstractAdapter
  ...
  # Rails 8.1 expects quote_column_name and quote_table_name as class methods
  # (used by Model.quoted_table_name via adapter_class.quote_table_name)
  class << self
  ...
  def self.native_database_types # :nodoc:
    @native_database_types ||= {
      ...
      time_with_timezone: { name: "TIME WITH TIME ZONE" },
